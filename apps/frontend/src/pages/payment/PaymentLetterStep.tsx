...
export function PaymentLetterStep() {
  ...
  return (
    <StepLayout
      title="Pagamento"
      subtitle="Selecione a primeira letra do seu nome"
    >
      <div className="rounded-3xl border border-brand-mist/40 bg-white/80 px-6 py-5 shadow-sm">
        ...
        <p className="mt-1 text-sm text-brand-dark/70">
          Digite o nome utilizando o teclado abaixo ou informe manualmente.
        </p>
        <input
          ref={inputRef}
          type="text"
        ...
        <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <span className="text-xs text-brand-dark/60">
            Não encontrou? Cadastre o nome rapidamente.
          </span>
          <Button
            type="button"
            fullWidth={false}
      ...
      <KeyboardLetters
        ...
        selectedLetter={selectedPaymentLetter}
      />
